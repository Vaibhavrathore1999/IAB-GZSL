...
def get_opt():
    ...
    parser.add_argument('--resnet_path', default='',
                        # resnet101_cub.pth.tar resnet101-5d3b4d8f.pth
    ...
    parser.add_argument('--latent_dim', type=int, default=4096,help='size of the latent space')
    parser.add_argument('--cls_dim', type=int, default=2048,help='size of the classification space')
    parser.add_argument('--feat_dim', type=int, default=2048,help='size of the features')
    ...
    #frozon backbone
    parser.add_argument('--unfix_low', type=bool, default=False)
    parser.add_argument('--unfix_high', type=bool, default=False)
    parser.add_argument('--unfix_vars', type=bool, default=False)
    parser.add_argument('--t', type=float, default=8)
    parser.add_argument('--Lp1', type=int, default=30)
    parser.add_argument('--gamma', type=int, default=2)
    parser.add_argument('--delta', type=float, default=0.5)
    parser.add_argument('--seen_classes', type=int, default=40, help='number of seen classes')
    parser.add_argument('--nclasses', type=int, default=50, help='number of all the classes')
    ...
    parser.add_argument('--alpha5', type=float, default=0.1)
    parser.add_argument('--alpha6', type=float, default=0.0)
